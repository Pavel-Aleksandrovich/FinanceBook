...
extension NewSegmentView: INewSegmentView {
    ...
    func getViewModel() -> ViewModelRequest {
        ...
        let color = TypeSection.allCases[self.categoryPicker.selectedRow(inComponent: Constants.component)].color
...
private extension NewSegmentView {
    ...
    func categoryToolbarDoneButtonTapped() {
        let name = TypeSection.allCases[self.categoryPicker.selectedRow(inComponent: Constants.component)].name
