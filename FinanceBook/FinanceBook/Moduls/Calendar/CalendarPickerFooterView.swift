...
class CalendarPickerFooterView: UIView {
    ...
    private let didTapPreviousMonthHandler: () -> ()
    private let didTapNextMonthHandler: () -> ()
    
    init(didTapPreviousMonthHandler: @escaping() -> (),
         didTapNextMonthHandler: @escaping() -> ()) {
        
        self.didTapPreviousMonthHandler = didTapPreviousMonthHandler
        self.didTapNextMonthHandler = didTapNextMonthHandler
    ...
    @objc func didTapPreviousMonthButton() {
        didTapPreviousMonthHandler()
    }
    
    @objc func didTapNextMonthButton() {
        didTapNextMonthHandler()
    }
}
