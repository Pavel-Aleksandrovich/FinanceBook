...
//    
//    func config(name: String?, color: UIColor?) {
//        self.transactionLabel.text = name
//        self.transactionLabel.textColor = color
//        self.transactionImageView.backgroundColor = color
//    }
//}
//
